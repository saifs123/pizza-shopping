...
public class buy extends JFrame
{
    ...
    private void initComponent()
    {
        ...
        cmd2=new JButton("Buy Now");
        this.getRootPane().setDefaultButton(cmd2);
        
        p1=new JPanel(new GridLayout(1,1,5,5));
        p1.setBorder(BorderFactory.createTitledBorder("Buy A Pizza"));
        p1.add(cbox1);
        
       p2=new JPanel(new GridLayout(10,2,5,5));
       p2.setBorder(BorderFactory.createTitledBorder("Update Bike Details"));
         p2.add(l1);
         p2.add(txt1);
         p2.add(l2);
         p2.add(txt2);
    ...
    private void fillComboBox()
    {
        ...
        try
        {
            ...
            PreparedStatement ps=connection.prepareStatement("select pid,pname,pprice from addpizza order by pid asc");
   ...
   private void buyNow()
   {
       try
       {
          int n=new Random().nextInt(10000);
           PreparedStatement ps=connection.prepareStatement("insert into buyer values(?,?,?,?,?,?,?,?,?,?,curdate())");
    ...
    public buy(Connection connection)
    {
        this.initComponent();
        //txt1.requestFocus();
